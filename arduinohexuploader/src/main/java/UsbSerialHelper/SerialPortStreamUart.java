...
import com.maromav.arduinohexuploader.ArduinoHexFileUploader;
...
public class SerialPortStreamUart implements ISerialPortStream {
    ...
    public SerialPortStreamUart(Context context, String portKey, int baud) {
        this.baudRate = baud;
        ...
        ArduinoHexFileUploader.UnityCall_Message(usbDevice.getDeviceName());
